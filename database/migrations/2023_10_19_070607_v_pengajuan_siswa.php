    ...
    public function up(): void
    {
        DB::unprepared(
            'CREATE OR REPLACE VIEW v_pengajuan_siswa AS 
                SELECT id_pengajuan, nis_siswa, nama, tingkat, nama_jurusan, kelompok, tanggal_pengajuan, status 
                FROM pengajuan_siswa INNER JOIN siswa ON pengajuan_siswa.nis_siswa = siswa.nis 
