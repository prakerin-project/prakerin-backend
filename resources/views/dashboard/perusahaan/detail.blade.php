...
@section('content')
  ...
  <div class="d-flex gap-4">
    <div class="foto-wrapper d-flex flex-column">
      <img src="{{ asset("storage/perusahaan/".$perusahaan->foto[0]->path) }}" class="main-foto" alt="first-image" width="500px" height="400px">
      <div class="small-foto d-flex mt-2 gap-2">
        @foreach ($perusahaan->foto as $foto )
        <img src="{{ asset('storage/perusahaan/'.$foto->path) }}" alt="" width="120px" height="100px">
