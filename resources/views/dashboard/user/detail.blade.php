            ...
            <div class="card w-100 bg-white">
                @isset($user->foto_profil)
                    <div class="d-flex justify-content-center">
                        <img src="{{ route('displayImage', ['uri' => $user->foto_profil, 'folder' => 'user']) }}"
                            class="mt-2 rounded-3 w-50" style="aspect-ratio:1/1;object-fit:cover" alt="{{ $user_detail->nama }}">
                    </div>
                @endisset
                <div class="mt-4 px-3">
                    <label class="w-100" for="">
                        <form id="uploadFoto" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col pe-0">
                                    <input accept=".jpg, .jpeg, .png, .svg" name="foto_profil"
                                        class="form-control rounded-start-4 rounded-end-0" type="file" id="formFile">
                                </div>
                                <div class="col-auto ps-0">
                                    <button
                                        class="btn btn-outline-secondary rounded-end-4 rounded-start-0 px-4">Upload</button>
                                </div>
                            </div>
                        </form>
                    </label>
                ...
                <div class="card-body">
                    ...
                    <div class="row mx-1 mt-3">
                        ...
                        <div class="col-auto p-0">
                            <a href="#"
                                class="deleteButton d-flex align-items-center gap-2 w-100 rounded-end-pill btn btn-danger">
